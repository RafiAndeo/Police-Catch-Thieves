...
if __name__=='__main__':
    ...
    k = 2
    n = len(arr2)
    print("Maksimum pencuri yang dapat ditangkap adalah: {}". format(tangkapPencuri(arr2, n, k)))

    arr3 = ['T', 'T', 'T', 'P', 'T', 'T']
    k = 2
    n = len(arr3)
    print("Maksimum pencuri yang dapat ditangkap adalah: {}". format(tangkapPencuri(arr3, n, k)))

    arr4 = ['T', 'T', 'T', 'P', 'T', 'T', 'T', 'P', 'T', 'T', 'T', 'P', 'T', 'T', 'T', 'P', 'T', 'T', 'T', 'P']
    k = 2
    n = len(arr4)
    print("Maksimum pencuri yang dapat ditangkap adalah: {}". format(tangkapPencuri(arr4, n, k)))